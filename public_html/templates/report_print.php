...
<div class="rp">
    <div class="rp-toolbar no-print">
        <a href="/report_view.php?id=<?= (int)$id ?>" class="btn btn-small btn-outline waves-effect"><i class="material-icons left">arrow_back</i>Back to report</a>
    ...
    <header class="rp-cover">
        <div class="rp-brand">ThreatIntelligence-TDL</div>
        ...
        <div class="rp-exec">
            ...
            <div class="rp-exec-stats">
                <div><span class="n"><?= number_format($totalDomains) ?></span><span class="l">domains detected</span></div>
                <div><span class="n"><?= number_format($statusCounts['review_required']) ?></span><span class="l">require review</span></div>
                <div><span class="n"><?= number_format($statusCounts['malicious']) ?></span><span class="l">confirmed malicious</span></div>
            </div>
            <ul class="rp-notes">
