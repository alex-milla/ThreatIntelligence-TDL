 ...
 * definition (historical recheck, tagged good/bad, or a WHOIS-validated domain
 * registered before the last successful scan of its TLD).
 */
 ...
 *
 * @return array{good_bad:string,observing:string,old_domain:string,hidden:string}
 */
