                                ...
                                <div class="dd-grid">
                                    ...
                                    <div class="dd-block">
                                        ...
                                        <dl class="dd-list">
                                            ...
                                            <div><dt>AlienVault OTX</dt><dd><span class="rep-pill rep-<?= htmlspecialchars($repOtx['state']) ?>"><?= htmlspecialchars($repSymbol[$repOtx['state']] ?? '') ?> <?= htmlspecialchars($repOtx['label']) ?></span><?php if ($repOtx['detail'] !== ''): ?> <span class="muted"><?= htmlspecialchars($repOtx['detail']) ?></span><?php endif; ?></dd></div>
